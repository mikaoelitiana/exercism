...
def check_drinks(drink_name, drink_ingredients):
    ...
    has_alcohol = len(set(drink_ingredients).intersection(ALCOHOLS)) > 0
    return f"{drink_name} {'Cocktail' if has_alcohol else 'Mocktail'}"
...
def singleton_ingredients(dishes, intersection):
    ...
    return set().union(*dishes).symmetric_difference(intersection)
